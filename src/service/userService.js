...
export default {
  ...
  uploadImg(data) {
    return new Promise((resolve, reject) => {
      axios.post("/api/user/uploadImg", data)
  ...
  getHotAuthorsList(params) {
    return new Promise((resolve, reject) => {
      axios.get("/api/user/getHotAuthorsList", { params })
        .then((res) => resolve(res))
        .catch((err) => reject(err));
    });
  },
  ...
  getUserInfo(params) {
    return new Promise((resolve, reject) => {
      axios.get("/api/auth/info", { params })
        .then((res) => resolve(res))
        .catch((err) => reject(err));
    });
  },
  ...
  getFollowCount(params) {
    return new Promise((resolve, reject) => {
      axios.get("/api/user/getFollowCount", { params })
        .then((res) => resolve(res))
        .catch((err) => reject(err));
    });
  },
  ...
  isValidUser(params) {
    return new Promise((resolve, reject) => {
      axios.get("/api/user/isValidUser", { params })
        .then((res) => resolve(res))
        .catch((err) => reject(err));
    });
  },
  ...
  getUserOperateCount(params) {
    return new Promise((resolve, reject) => {
      axios.get("/api/user/getUserOperateCount", { params })
        .then((res) => resolve(res))
        .catch((err) => reject(err));
    });
  }
